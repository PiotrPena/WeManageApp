...
CREATE TABLE Salaries (
    ...
    Currency VARCHAR(3), -- Add this line for currency
    StartDate DATE,
    EndDate DATE NULL,
    FOREIGN KEY (EmployeeID) REFERENCES Employees(EmployeeID)
);
...
INSERT INTO Salaries (EmployeeID, MonthlySalary, Currency, StartDate, EndDate)
VALUES
(1, 5000, 'USD', '2018-01-01', '2019-06-30'),
(1, 5500, 'USD', '2019-07-01', '2020-06-30'),
(1, 6000, 'USD', '2020-07-01', NULL),

(2, 7000, 'GBP', '2017-01-01', '2018-06-30'),
(2, 7500, 'GBP', '2018-07-01', '2019-06-30'),
(2, 8000, 'GBP', '2019-07-01', NULL),

(3, 4000, 'USD', '2018-01-01', '2019-12-31'),
(3, 4500, 'USD', '2020-01-01', NULL),

(4, 6000, 'USD', '2016-01-01', '2017-12-31'),
(4, 6500, 'USD', '2018-01-01', NULL),

(5, 5500, 'USD', '2017-02-01', '2018-01-31'),
(5, 6000, 'USD', '2018-02-01', NULL),

(6, 5000, 'EUR', '2019-03-01', '2020-02-29'),
(6, 5500, 'EUR', '2020-03-01', NULL),

(7, 8000, 'USD', '2017-04-01', '2018-03-31'),
(7, 8500, 'USD', '2018-04-01', NULL),

(8, 4000, 'USD', '2019-05-01', '2020-04-30'),
(8, 4500, 'USD', '2020-05-01', NULL),

(9, 4800, 'USD', '2018-06-01', '2019-05-31'),
(9, 5000, 'USD', '2019-06-01', NULL),

(10, 4300, 'EUR', '2017-07-01', '2018-06-30'),
(10, 4600, 'EUR', '2018-07-01', NULL),

(11, 5200, 'USD', '2016-08-01', '2017-07-31'),
(11, 5600, 'USD', '2017-08-01', '2018-07-31'),
(11, 6000, 'USD', '2018-08-01', NULL),

(12, 6200, 'GBP', '2017-09-01', '2018-08-31'),
(12, 6600, 'GBP', '2018-09-01', '2019-08-31'),
(12, 7000, 'GBP', '2019-09-01', NULL);
